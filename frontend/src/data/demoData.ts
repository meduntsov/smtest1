...
export const aiRecommendations = [
  {
    text: 'Фасад Корпус 1 имеет отставание 18 дней. С высокой вероятностью это вызовет сдвиг транша №2 и рост процентной нагрузки на 4,2 млн руб.',
    issue: {
      code: 'ISSUE-241',
      url: 'https://tracker.example.com/issues/ISSUE-241'
    }
  },
  {
    text: 'Тендер на лифтовое оборудование не завершён. Риск блокировки ввода в эксплуатацию через 60 дней.',
    issue: {
      code: 'ISSUE-198',
      url: 'https://tracker.example.com/issues/ISSUE-198'
    }
  },
  {
    text: 'Вероятность нарушения ковенанта DSCR в Q4: 42%. Рекомендуется перенос части CAPEX на следующий период.',
    issue: {
      code: 'ISSUE-275',
      url: 'https://tracker.example.com/issues/ISSUE-275'
    }
  }
];
